...
## Alternate zipcode method:

It's also possible to collect phone zip codes from users when they dial in, rather than on the form. You can find a demo of that [here](http://tfrce.github.io/call-widget/example/default-nozip.html), and view the page source [here](https://github.com/tfrce/call-widget/blob/gh-pages/example/default-nozip.html).
